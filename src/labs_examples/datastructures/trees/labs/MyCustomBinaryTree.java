...
public class MyCustomBinaryTree {
    ...
    //used to keep track of the root node of the tree
    Node root;

    //constructor allows user to enter initial data values to
    public MyCustomBinaryTree(String...data){
    ...
    public void add(String element){
        ...
        Node newNode = new Node(assignmentNumber, element);
    ...
    public Node add(Node newNode, Node node){
    ...
    private Node rebalanceAfterInsert(Node newNode, Node node){
